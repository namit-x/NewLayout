    ...
    >
      <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
        <nav className="flex items-center justify-between h-14 sm:h-16 md:h-18 lg:h-20 xl:h-22 relative">
          {/* Logo + Firm Name */}
          <div className="flex items-center gap-1.5 sm:gap-2 md:gap-3 z-10 flex-shrink-0">
            <img 
              className="w-6 h-6 xs:w-7 xs:h-7 sm:w-8 sm:h-8 md:w-9 md:h-9 lg:w-10 lg:h-10 xl:w-11 xl:h-11" 
              src={logoUrl} 
              alt="Logo" 
            />
            <div className={`font-playfair font-semibold tracking-tight ${
          ...
          <div className="flex gap-1.5 sm:gap-2 md:gap-3 lg:gap-4 items-center relative">
            ...
            >
              ...
              {/* <span className="hidden xs:inline sm:hidden md:inline">Call</span> */}
